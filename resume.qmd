...
-   Bioinformatics, Molecular Epidemiology, Infectious Disease Modeling
...
-   Center for Applied Pathogen Epidemiology and Outbreak Response (CAPE), University of Georgia
...
-   Computer and Electronics in Agriculture **(IF: 8.3)**
-   Sensors **(IF: 3.9)**
-   Animals **(IF: 3.0)**
