...
-   Computer and Electronics in Agriculture **(IF: 8.9)** \[14 Papers\]

-   Smart Agricultural Technology **(IF: 5.7)** \[4 Papers\]

-   AI **(IF: 5.0)** \[2 Papers\]

-   Antibiotics **(IF: 4.6)** \[1 Paper\]

-   Nanomaterials **(IF: 4.3)** \[1 Paper\]

-   Scientific Reports **(IF: 3.9)** \[1 Paper\]

-   Sensors **(IF: 3.5)** \[1 Paper\]

-   Vaccines **(IF: 3.4)** \[2 Papers\]

-   Ecological Modeling **(IF: 3.2)** \[3 Papers\]

-   AgriEngineering **(IF: 3.0)** \[1 Paper\]

-   Infectious Disease Modeling **(IF: 2.5)** \[2 Papers\]

-   Animals **(IF: 2.7)** \[5 Papers\]

-   Applied Sciences **(IF: 2.5)** \[1 paper\]

-   Cogent Food and Agriculture **(IF: 2.3)** \[1 paper\]

-   Veterinary Sciences **(IF: 2.3)** \[5 Papers\]
